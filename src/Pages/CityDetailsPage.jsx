...
function CityDetailsPage() {
  ...
  return (
    <div className="bg-gray-100 p-6 m-4 rounded-lg shadow-lg max-w-3xl mx-auto">
      <h2 className="text-3xl font-semibold mb-4 text-blue-600">{cityData.name}</h2>
      <img src={cityData.image} alt={cityData.name} className="w-full h-64 object-cover mb-4 rounded-md" />
